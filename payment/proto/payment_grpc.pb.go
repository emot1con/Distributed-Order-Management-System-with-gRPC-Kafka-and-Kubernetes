...
type PaymentServiceClient interface {
	PayOrder(ctx context.Context, in *CreatePaymentRequest, opts ...grpc.CallOption) (*EmptyPayment, error)
}
...
func (c *paymentServiceClient) PayOrder(ctx context.Context, in *CreatePaymentRequest, opts ...grpc.CallOption) (*EmptyPayment, error) {
...
type PaymentServiceServer interface {
	PayOrder(context.Context, *CreatePaymentRequest) (*EmptyPayment, error)
...
func (UnimplementedPaymentServiceServer) PayOrder(context.Context, *CreatePaymentRequest) (*EmptyPayment, error) {
