...
type ProductServiceClient interface {
	...
	UpdateProduct(ctx context.Context, in *GetProductRequest, opts ...grpc.CallOption) (*Product, error)
...
func (c *productServiceClient) UpdateProduct(ctx context.Context, in *GetProductRequest, opts ...grpc.CallOption) (*Product, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Product)
...
type ProductServiceServer interface {
	...
	UpdateProduct(context.Context, *GetProductRequest) (*Product, error)
...
func (UnimplementedProductServiceServer) UpdateProduct(context.Context, *GetProductRequest) (*Product, error) {
